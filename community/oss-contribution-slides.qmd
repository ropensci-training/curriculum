...
format: 
  revealjs:
    theme: [default, slides_styles/stilos.scss]
    logo: ropensci.svg
    slide-number: c/t
---
...
* Si te gusta dar charlas, puedes presentar en un Grupo de Usuarios de R o [Capítulo de RLadies+](https://rladies.org/chapters/).

* Presentar tu paquete en una **conferencia específica del dominio** o en conferencias específicas de R ([LatinR](https://latinr.org) ;-)).
